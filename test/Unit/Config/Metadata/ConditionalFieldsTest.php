...
namespace Horde\Core\Test\Unit\Config\Metadata;
...
class ConditionalFieldsTest extends TestCase
{
    ...
    public function testUnicodeInCaseValues(): void
    {
        ...
        $conditional = new ConditionalFields([
            "\u{65E5}\u{672C}\u{8A9E}" => [$field],
            "\u{0645}\u{0631}\u{062D}\u{0628}\u{0627}" => [$field],
        ]);

        $this->assertTrue($conditional->hasCase("\u{65E5}\u{672C}\u{8A9E}"));
        $this->assertTrue($conditional->hasCase("\u{0645}\u{0631}\u{062D}\u{0628}\u{0627}"));
    }
