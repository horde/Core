 ...
 * `$_SESSION`, and optional {@see Horde_Core_Secret_Cbc} re-keying on `clean()` /
 * `destroy()`.
 *
...
class SessionLifecycle implements Horde_Shutdown_Task
{
     ...
     * @param Horde_Core_Secret_Cbc|null $secret   Optional. Re-keyed on clean(),
     *                                        cleared on destroy().
     */
    public function __construct(
        ...
        private readonly ?Horde_Core_Secret_Cbc $secret = null,
    ) {}
     ...
     * `_b`/`_r` timestamps, and rotates the {@see Horde_Core_Secret_Cbc} key.
