...
/**
 * SQL group driver configuration metadata.
 *
 * Provides field definitions and validation for SQL-based group management.
 *
 * @author    Ralf Lang <ralf.lang@ralf-lang.de>
 * @category  Horde
 * @copyright 2026 The Horde Project
 ...
 * @package   Core
 */
class SqlGroupDriver implements DriverInterface
{
