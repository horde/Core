...
/**
 * SQL preferences driver configuration metadata.
 *
 * Provides field definitions and validation for SQL-based preferences storage.
 *
 * @author    Ralf Lang <ralf.lang@ralf-lang.de>
 * @category  Horde
 * @copyright 2026 The Horde Project
 ...
 * @package   Core
 */
class SqlPrefsDriver implements DriverInterface
{
    ...
    public function getFields(): array
    {
        return [
            ...
            new PropertyMetadata(
                name: 'table',
                type: FieldType::TEXT,
                description: 'Preferences table name',
                required: false,
                default: 'horde_prefs',
            ),
        ];
