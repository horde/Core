...
/**
 * Application authentication driver configuration metadata.
 *
 * Delegates authentication to another Horde application.
 *
 * @author    Ralf Lang <ralf.lang@ralf-lang.de>
 * @category  Horde
 * @copyright 2026 The Horde Project
 ...
 * @package   Core
 */
class ApplicationAuthDriver implements DriverInterface
{
    ...
    {
        return 'Let a Horde application handle authentication';
    }
    ...
    public function getFields(): array
    {
        return [
            new PropertyMetadata(
                name: 'app',
                type: FieldType::TEXT,
                description: 'Application providing authentication (e.g., imp)',
                required: true,
                default: 'imp',
            ),
        ];
